...
class RsiaMappingProcedureRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if ($this->isMethod('POST')) {
            $rules['kd_jenis_prw'] = 'required|string|max:15|exists:jns_perawatan,kd_jenis_prw';
    ...
    {
        return [
            'kd_jenis_prw.required' => 'Kode jenis perawatan wajib diisi',
            'kd_jenis_prw.exists' => 'Kode jenis perawatan tidak valid',
