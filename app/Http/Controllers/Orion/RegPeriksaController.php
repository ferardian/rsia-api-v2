...
class RegPeriksaController extends \Orion\Http\Controllers\Controller
{
    ...
    {
        return ['pasien', 'pasienSomeData', 'dokter', 'poliklinik', 'sepSimple', 'dokter.spesialis', 'pasienBayi', 'caraBayar', 'pemeriksaanRalan', 'pemeriksaanRanap', 'periksaRadiologi', 'periksaRadiologi.dokter', 'periksaRadiologi.petugas', 'periksaRadiologi.jenisPerawatan', 'periksaRadiologi.hasilRadiologi', 'periksaRadiologi.gambarRadiologi'];
    }
}
